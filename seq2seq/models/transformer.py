...
from seq2seq.modules.sinusoidal_positional_embedding import SinusoidalPositionalEmbedding
from seq2seq.modules.multihead_attention import MultiheadAttention

from seq2seq.models.encoder import BaseEncoder
from seq2seq.models.decoder import BaseDecoder
from seq2seq.models.model import BaseModel
...
class TransformerModel(BaseModel):
    ...
    @classmethod
    def build_model(cls, args, src_dictionary, tgt_dictionary):
        ...
        src_dict, tgt_dict = src_dictionary, tgt_dictionary
...
class TransformerDecoder(BaseDecoder):
    ...
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False, left_pad=False, final_norm=True):
        ...
        if args.adaptive_softmax_cutoff is not None:
            ...
            # )
            raise argparse.ArgumentError('unsupport adaptive softmax')
...
def PositionalEmbedding(num_embeddings, embedding_dim, padding_idx, left_pad, learned=False):
    if learned:
        raise argparse.ArgumentError('unsupport learned position embedding')
    else:
